...
<head>
  ...
  <title>Tambah Stok Parkir</title>
  ...
  <div class="card shadow-sm border-0">
    ...
    <div class="card-body p-4">
      ...
      <form action="{{ route('stok.store') }}" method="POST">
        ...
        {{-- Total Slot --}}
        <div class="mb-3">
          <label for="total_slot" class="form-label">Total Slot</label>
          <input type="number" name="total_slot" id="total_slot"
                 class="form-control @error('total_slot') is-invalid @enderror"
                 placeholder="Jumlah kapasitas lahan" value="{{ old('total_slot') }}" min="1" required>
          @error('total_slot')

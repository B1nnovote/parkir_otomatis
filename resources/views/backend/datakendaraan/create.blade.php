            ...
            <div class="card-body">
              <form action="{{ route('datakendaraan.store') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="no_polisi" id="plat_nomor" class="form-control" placeholder="Contoh: B 1234 XYZ" required>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" name="pemilik" id="pemilik" class="form-control" placeholder="Nama lengkap" required>
                </div>
                ...
                <div class="d-flex justify-content-between">
                  <a href="{{ route('datakendaraan.index') }}" class="btn btn-outline-secondary">← Kembali</a>
